...
import { startQueue, stopQueue, registerProcessor } from './utils/queue.js';
...
registerProcessor('reports',   processReportJob);
registerProcessor('bpjs',      processBpjsJob);
registerProcessor('satusehat', processSatuSehatJob);
