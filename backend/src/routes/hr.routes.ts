...
router.get('/employees',
  ...
  asyncHandler(async (req: Request<{}, {}, {}, EmployeesQuery>, res: Response) => {
...
router.get('/attendance',
  requireRole([ROLES.HRD, ROLES.MANAJEMEN]),
  asyncHandler(async (req: Request<{}, {}, {}, AttendanceQuery>, res: Response) => {
...
router.post('/attendance/checkin',
  asyncHandler(async (req: Request<{}, {}, CheckinBody>, res: Response) => {
...
router.get('/leave-requests',
  requireRole([ROLES.HRD, ROLES.MANAJEMEN]),
  asyncHandler(async (req: Request<{}, {}, {}, LeaveQuery>, res: Response) => {
...
router.post('/leave-requests',
  asyncHandler(async (req: Request<{}, {}, LeaveBody>, res: Response) => {
...
router.get('/payroll',
  ...
  asyncHandler(async (req: Request<{}, {}, {}, PayrollQuery>, res: Response) => {
...
router.post('/payroll/generate',
  requireRole([ROLES.HRD]),
  asyncHandler(async (req: Request<{}, {}, PayrollGenerateBody>, res: Response) => {
    const { month, year, departmentId } = req.body;

    // Get all active employees
    const where: Record<string, unknown> = { employment_type: 'aktif' };
    if (departmentId) where.department_id = departmentId;
    ...
    const payrollRecords = await Promise.all(
      employees.map(async (emp) => {
        ...
        const allowances = 0; // TODO: Add allowances field to payroll structure
...
router.get('/trainings',
  ...
  asyncHandler(async (req: Request, res: Response) => {
    const trainings = await prisma.trainings.findMany({
      // training_participants relation not available in schema,
 ...
 */
router.get('/schedules', asyncHandler(async (req: Request<{}, {}, {}, SchedulesQuery>, res: Response) => {
 ...
 */
router.post('/schedules', requireRole([ROLES.HRD, ROLES.ADMIN]), asyncHandler(async (req: Request, res: Response) => {
 ...
 */
router.put('/schedules/:id', requireRole([ROLES.HRD, ROLES.ADMIN]), asyncHandler(async (req: Request<{ id: string }>, res: Response) => {
  const { id } = req.params;
 ...
 */
router.delete('/schedules/:id', requireRole([ROLES.HRD, ROLES.ADMIN]), asyncHandler(async (req: Request<{ id: string }>, res: Response) => {
  const { id } = req.params;
 ...
 * GET /api/hr/shifts
 */
router.get('/shifts', asyncHandler(async (req: Request<{}, {}, {}, ShiftsQuery>, res: Response) => {
 ...
 * POST /api/hr/shifts
 */
router.post('/shifts', requireRole([ROLES.HRD, ROLES.ADMIN]), asyncHandler(async (req: Request, res: Response) => {
 ...
 */
router.put('/shifts/:id', requireRole([ROLES.HRD, ROLES.ADMIN]), asyncHandler(async (req: Request<{ id: string }>, res: Response) => {
  const { id } = req.params;
