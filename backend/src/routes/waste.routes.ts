...
// RECORDS
router.get('/records', asyncHandler(async (req: Request<Record<string, string>, any, any, RecordsQuery>, res: Response) => {
  ...
  if (start_date || end_date) {
    where.record_date = {};
    if (start_date) (where.record_date as Record<string, unknown>).gte = new Date(start_date);
    if (end_date) (where.record_date as Record<string, unknown>).lte = new Date(end_date);
  }
...
router.put('/records/:id', asyncHandler(async (req: Request<{ id: string }>, res: Response) => {
...
// MONTHLY SUMMARY
router.get('/summary', asyncHandler(async (req: Request<Record<string, string>, any, any, SummaryQuery>, res: Response) => {
