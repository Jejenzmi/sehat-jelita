...
// Type definitions
interface LoginBody extends z.infer<typeof loginSchema> { }
interface RegisterBody extends z.infer<typeof registerSchema> { }
 ...
 */
router.post('/login', authRateLimiter, asyncHandler(async (req: Request<Record<string, string>, any, LoginBody>, res: Response) => {
 ...
 */
router.post('/register', authRateLimiter, asyncHandler(async (req: Request<Record<string, string>, any, RegisterBody>, res: Response) => {
 ...
 */
router.post('/refresh', asyncHandler(async (req: Request<Record<string, string>, any, RefreshBody>, res: Response) => {
  ...
  try {
    ...
    throw new ApiError(401, (err as Error).message, 'INVALID_REFRESH_TOKEN');
  }
}));
 ...
 */
router.post('/logout', authenticateToken, asyncHandler(async (req: Request<Record<string, string>, any, RefreshBody>, res: Response) => {
...
router.post('/logout-all', authenticateToken, asyncHandler(async (req: Request, res: Response) => {
  ...
  await revokeTokens(req._rawToken, undefined);
 ...
 */
router.post('/change-password', authenticateToken, asyncHandler(async (req: Request<Record<string, string>, any, ChangePasswordBody>, res: Response) => {
 ...
 */
router.post('/forgot-password', authRateLimiter, asyncHandler(async (req: Request<Record<string, string>, any, ForgotPasswordBody>, res: Response) => {
  ...
  if (profile) {
    ...
    const template = emailTemplates.passwordReset({ resetUrl, userName: profile.full_name || email });
    await sendEmail({ to: email, ...template }).catch((err: Error) => {
 ...
 */
router.post('/reset-password', authRateLimiter, asyncHandler(async (req: Request<Record<string, string>, any, ResetPasswordBody>, res: Response) => {
