 ...
 * User login
 */
export const login = async (req: Request<unknown, unknown, LoginBody>, res: Response, next: NextFunction): Promise<void> => {
  try {
 ...
 * User registration
 */
export const register = async (req: Request<unknown, unknown, RegisterBody>, res: Response, next: NextFunction): Promise<void> => {
  try {
 ...
 */
export const refresh = async (req: Request<unknown, unknown, RefreshBody>, res: Response, next: NextFunction): Promise<void> => {
  try {
  ...
  try {
    ...
    res.json({
      ...
      data: {
        ...
        roles: profile.user_roles.map(r => r.role),
        employee: (profile.employees as unknown[] | null)?.[0] || null
      }
    });
  } catch (error) {
    next(error);
 ...
 * Change password
 */
export const changePassword = async (req: Request<unknown, unknown, ChangePasswordBody>, res: Response, next: NextFunction): Promise<void> => {
  try {
 ...
 */
export const requestPasswordReset = async (req: Request<unknown, unknown, ResetRequestBody>, res: Response, next: NextFunction): Promise<void> => {
  try {
 ...
 */
export const resetPassword = async (req: Request<unknown, unknown, ResetPasswordBody>, res: Response, next: NextFunction): Promise<void> => {
  try {
