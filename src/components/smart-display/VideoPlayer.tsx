...
const defaultVideos: VideoItem[] = [
  ...
  },
  {
    ...
    title: "Pencegahan Infeksi di Rumah Sakit",
  },
  {
    id: "3",
    url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4",
    title: "Tips Hidup Sehat untuk Keluarga",
  },
];

export function VideoPlayer({ videos = defaultVideos, autoPlay = true, muted: initialMuted = true }: VideoPlayerProps) {
            ...
            {videos.map((v, i) => (
              ...
              >
                <div className={`w-6 h-6 rounded-full flex items-center justify-center shrink-0 text-[10px] font-bold ${
                  ...
                  {i === currentIdx && playing ? <Play className="h-3 w-3" /> : i + 1}
                </div>
